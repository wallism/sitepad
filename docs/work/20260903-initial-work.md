...
Branch: `master`  
Mode: Builder  
Status: REVIEWED — READY FOR MILESTONE 1
...
The four milestones in this document are the reviewed v0.1 roadmap. **Milestone 1 is the only currently authorized implementation scope.** Milestones 2-4 define where the architecture must be able to go; they are not permission to start networking, conflict UI, photo work, or a wider screen set early.
